...
public class Set_03_use_of_treeSet {
	...
	public static void main(String[] args) {
		...
		// lower()  --> Returns the least element in this set strictly less than the given element, 
		System.out.println("Lower Sorted Element: " + treeSet.lower("Charlie"));
		
		// headSet() --> Returns a view of the portion of this set whose elements are strictly less than to Element. 
		System.out.println( treeSet.headSet("Douglas")); 
		// tailSet() --> Returns a view of the portion of this set whose elements are greater than or equal to from Element. 
