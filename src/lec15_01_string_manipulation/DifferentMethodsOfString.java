package lec15_01_string_manipulation;
...
public class DifferentMethodsOfString {
	public static void main(String[] args) {
		...
		System.out.println(s.indexOf('r', s.indexOf('r', s.indexOf('r') + 2) + 1));
		...
		System.out.println(s.indexOf('p', s.indexOf('p', s.indexOf('p') + 2)+1));
		...
		// How about String
		// We can also use == equal to ---> to compare 2 string, but need to be careful for line 129
		System.out.println("\n------------------------------------------------------------------------");
		...
		System.out.println("After replacing by String: " + s9.replaceAll("mom", "Dad"));
		...
		String s20 = String.valueOf(age4); // formula, learned in Wrapper class
