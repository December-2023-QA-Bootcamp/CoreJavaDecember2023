...
import lec08_07_java_access_modifier_class_from_outside_package.N;

// Here B is the child class inside same package
public class B extends C {
	...
	public static void main(String[] args) {
		...
		System.out.println("\n---------- public type modifier content of Parent class [W] from same package can be accessed in non-sub/child class (Here B)  ----------");
		W w = new W();
		w.w();
