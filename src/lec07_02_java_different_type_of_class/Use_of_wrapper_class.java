...
public class Use_of_wrapper_class {
	...
	public static void main(String[] args) {
		...
		// 100 2010, Here: 20+10 is not following Java Arithmetic Operators: addition
		System.out.println(name1 + " " + (20 + 10));
		// 100 30 (new), Here: (20+10) following Java Arithmetic Operators: addition, because inside parentheses
		...
		// 145 20102056
		// most common and important interview question: how can you convert a String to int? Ans:  Integer.parseInt(name1)
		...
		// so no execution below, so thats why we comment above line
		...
		String employee2 = null; // null or empty
		System.out.println(employee2); // outcome will be empty or null
		System.out.println(Boolean.parseBoolean(employee2)); // false, important interview question, default value of boolean will print
		...
		/*
		 ...
		 default value of String is null  ---- Important Interview Question
		 ...
		 default value of byte, short, long is 0 [Zero]
		 default value of float, double is 0 [Zero]
