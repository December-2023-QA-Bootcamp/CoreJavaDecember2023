...
public class UseOfArray03 {
	...
	public static void main(String[] args) {
		...
		// New --> if you need a selected part from the previous/existing Array
		System.out.println("\n------------------------------------------------------------------------");
		int[] d = Arrays.copyOfRange(c, 2, 10); // if you need to decrease or a specific size from the old Array
		...
		System.out.println("Is Array a and c is equal? Ans: " + Arrays.equals(a, d));
