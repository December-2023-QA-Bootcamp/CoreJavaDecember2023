...
public class UseOfArray02 {
	...
	public static void main(String[] args) {
		...
		// Que: how can you find the first member from an array?
		...
		A regular for loop, no relation with Array or ArrayList or something
		for(int i=0; i<5; i++) {
		...
		*/
		...
		// here m is the name of the loop, and a is the name of the array
		// first data type, then name of the loop, then : , then name of the array need to iterate
		for(int m : a) {
