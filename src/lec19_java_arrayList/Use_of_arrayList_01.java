...
public class Use_of_arrayList_01 {
	public static void main(String[] args) {
		...
		// Adding elements by add() --> Appends the specified element to the end of this
		// list.
		ar.add("Alex"); // index [0]
		...
		// very very important interview question: Iterator [used for List, Set] vs ListIterator [used for List]
		...
		// add(), get(), size(), Iterator is important from this class
