...
// From where of the line you have to start coding?
// if you want to code from line 6, you have to put your cursor at the end of line 5 and then press 'Enter'
public class StudentDecember {
	public static void main(String[] args) {
		...
		// line 11 and 12: high level, no need to know
		...
		// select the class from left -- right click -- refactor -- rename -- (change
		// name) -- finish -- finish
