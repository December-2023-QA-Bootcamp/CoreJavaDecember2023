...
public class VehicleTest {
	...
	public static void main(String[] args) {
		...
		// so, Toyota itself can initialize that method, but in terms of Interface, it (here gear method) is not allowed for Toyota [line 34]
		Toyota.yearOfEstablishment();
		toyota.flyingFeature();
		toyota.honk();
		// toyota.gear();
		// Toyota.gear();
		// gear () is a static method of an Interface, static method of an Interface can't be call by object of a regular class (line 33)
		// or by the regular class itself (line 34)
