...
public class S06_example_of_switch_in_finding_your_voter_eligibilty {
	...
	public static void main(String[] args) {
		...
		case 3:
			System.out.println("You are a voter for >=12 years, no need to register.");
			break;

		case 4:
			System.out.println("You are a voter for >=47 years, do you need any assistance?");
			break;
